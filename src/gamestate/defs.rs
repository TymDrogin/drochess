        ...
        match side_to_mode {
            Side::White => match cs {
                CastlingSide::Kingside => {
                    matches!(self.white, CastlingSide::Kingside | CastlingSide::Both)
                }
                CastlingSide::Queenside => {
                    matches!(self.white, CastlingSide::Queenside | CastlingSide::Both)
                }
            ...
            Side::Black => match cs {
                CastlingSide::Kingside => {
                    matches!(self.black, CastlingSide::Kingside | CastlingSide::Both)
                }
                CastlingSide::Queenside => {
                    matches!(self.black, CastlingSide::Queenside | CastlingSide::Both)
                }
